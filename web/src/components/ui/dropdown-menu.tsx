...
function DropdownMenuArrow({ className, ...props }: MenuPrimitive.Arrow.Props) {
  return (
    <MenuPrimitive.Arrow
      ...
      className={cn(
        'z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-sm border bg-popover data-[side=bottom]:top-0 data-[side=left]:-right-1 data-[side=right]:-left-1 data-[side=top]:-bottom-2.5',
        className
      )}
      {...props}
    />
