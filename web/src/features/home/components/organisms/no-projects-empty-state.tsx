      ...
      >
        ...
        <div className="relative flex flex-col items-center gap-3 px-9 py-8 text-center">
          ...
          <p className="max-w-[320px] text-xs leading-5 text-muted-foreground">
            ...
            <AddProjectIcon interactive onClick={props.onAddProject} /> next to
            Projects to add your first project.
          </p>
        </div>
 ...
 */
function AppPreview(props: { onAddProject?: () => void | Promise<void> }) {
  return (
    <div className="relative flex h-[253px] w-[424px] items-start justify-start overflow-hidden pt-[26px] pl-14">
      <div className="relative flex w-[368px] shrink-0 flex-col overflow-hidden rounded-tl-xl border-t border-l border-border bg-background shadow-[0_16px_40px_rgba(10,10,10,0.14),0_2px_8px_rgba(10,10,10,0.08)] dark:shadow-[0_16px_40px_rgba(0,0,0,0.55),0_2px_8px_rgba(0,0,0,0.4)]">
        {/* Header */}
        <div
          aria-hidden="true"
          ...
          <div className="flex w-[200px] shrink-0 flex-col gap-[18px] border-r border-border bg-sidebar px-3 py-3.5">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex h-5 items-center justify-between">
                ...
                <AddProjectIcon interactive onClick={props.onAddProject} />
              </div>
            </div>
          </div>
        ...
        {/* Pointer + tooltip on the Projects "+" */}
...
function AddProjectCallout(props: { className?: string }) {
  return (
    <div
      aria-hidden="true"
      className={cn(
        'flex items-center gap-2 rounded-lg bg-neutral-900 py-1.5 pr-[9px] pl-[11px] shadow-[0_10px_24px_rgba(10,10,10,0.28)] dark:border dark:border-neutral-700 dark:bg-neutral-800',
        props.className
      )}
    >
      ...
      <span className="flex items-center gap-[3px]">
        <Kbd className="h-[18px] min-w-[18px] rounded-[5px] bg-white/10 text-neutral-200">
          {MOD_KEY}
        </Kbd>
        <Kbd className="h-[18px] min-w-[18px] rounded-[5px] bg-white/10 text-neutral-200">
          N
