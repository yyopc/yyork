    ...
    variants: {
      variant: {
        ...
        'destructive-secondary':
          'border-border bg-background text-destructive shadow-xs hover:border-transparent hover:bg-destructive/20 dark:hover:bg-destructive/30',
        positive:
          'bg-positive-100 text-positive-800 hover:bg-positive-200 dark:bg-positive-500/25 dark:text-positive-100 dark:hover:bg-positive-500/35',
        warning:
          'bg-warning-100 text-warning-800 hover:bg-warning-200 dark:bg-warning-500/25 dark:text-warning-100 dark:hover:bg-warning-500/35',
